...
import (
	"yujie_goadmin/app/controller/monitor/job"
	"yujie_goadmin/app/controller/monitor/logininfor"
	"yujie_goadmin/app/controller/monitor/online"
	"yujie_goadmin/app/controller/monitor/operlog"
	"yujie_goadmin/app/controller/monitor/server"
